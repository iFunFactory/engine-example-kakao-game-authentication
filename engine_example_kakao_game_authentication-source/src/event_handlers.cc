...
#include "engine_example_kakao_game_authentication_loggers.h"
#include "engine_example_kakao_game_authentication_messages.pb.h"
...
void OnPbufEchoMessage(const Ptr<Session> &session, const Ptr<FunMessage> &message) {
  ...
  // Please see engine_example_kakao_game_authentication_messages.proto.
  //
  // In this example,
...
void RegisterEventHandlers() {
   ...
   */
  {
    Timer::ExpireRepeatedly(boost::posix_time::seconds(1), engine_example_kakao_game_authentication::OnTick);
  }
}
