 ...
 public:
  static bool Install(const ArgumentMap &arguments) {
    ...
    LOG(INFO) << "example_arg2: " << arg2;
     ...
     // You can override gflag like this: ./engine_example_kakao_game_authentication-local --example_arg3=hahaha
     ...
     */
    engine_example_kakao_game_authentication::RegisterEventHandlers();
...
REGISTER_STARTABLE_COMPONENT(EngineExampleKakaoGameAuthenticationServer, EngineExampleKakaoGameAuthenticationServer)
